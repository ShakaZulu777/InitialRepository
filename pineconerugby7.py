...
# ElevenLabs (now just using `generate`)
...
# Set environment variables for other APIs
os.environ["OPENAI_API_KEY"] = openai_api_key
os.environ["PINECONE_API_KEY"] = pinecone_api_key
# ELEVENLABS_API_KEY is already set from .env, no need for set_api_key if version doesn’t support it.
